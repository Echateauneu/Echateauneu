...
**Tools:** Git, GitHub, Linux, GitHub Actions  
**Currently learning:** German (B1), ML system design, deployment workflows
...
- **Game & Logic Prototypes** — browser-playable experiments to practice algorithms and UI  

*(More projects coming soon, including a complete backend API and a structured ML pipeline.)*
